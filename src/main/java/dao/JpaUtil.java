...
public class JpaUtil {
     ...
     */
    public static final String PERSISTENCE_UNIT_NAME = "persistUnit";
    
    /**
     * Indicateur d'affichage du Log de JpaUtil. Si true, le Log de JpaUtil
     * s'affiche dans la console; sinon, le log ne s'affiche pas.
     */
    ...
    /**
     * Initialise la Fabrique (Factory) de Contexte de Persistance (Entity
     * Manager).
    ...
    /**
     * Créée l'instance courante du Contexte de Persistance (Entity Manager),
     * liée à ce Thread.
    ...
    /**
     * Ferme l'instance courante du Contexte de Persistance (Entity Manager),
     * liée à ce Thread.
     * <br><strong>À utiliser uniquement au niveau Service.</strong>
     */
    ...
    /**
     * Démarre une transaction sur l'instance courante du Contexte de
     ...
     * Persistance (Entity Manager). Si la transaction courante n'est pas
     * démarrée, cette méthode n'effectue aucune opération.
     * <br><strong>À utiliser uniquement au niveau Service.</strong>
     */
